...
// +kubebuilder:webhook:path=/validate-slinky-slurm-net-v1alpha1-restapi,mutating=false,failurePolicy=fail,sideEffects=None,groups=slinky.slurm.net,resources=restapis,verbs=create;update,versions=v1alpha1,name=restapi-v1alpha1.kb.io,admissionReviewVersions=v1;v1alpha1
